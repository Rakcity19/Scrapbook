...
const pages = [
  // Text / Choice (3 total)
  { type: "text",   prompt: "Where was this photo taken?",            answers: ["amman", "abdoun"],          image: "images/1.jpg" },
  { type: "choice", prompt: "Before or after graduation?",           choices: ["Before", "After"],         correctIndex: 0,       image: "images/2.jpg" },
  { type: "text",   prompt: "What song were you obsessed with?",     answers: ["yellow", "coldplay"],      image: "images/3.jpg" },

  // Audio (Guitar) forgiving (3 total)
  { type: "audio", mode: "guitar", prompt: "🎸 Play the A chord (or any chord) for 2 seconds.", minSeconds: 2.0, minRms: 0.02, image: "images/4.jpg" },
  { type: "audio", mode: "guitar", prompt: "🎸 Strum for 3 seconds (a little louder).",         minSeconds: 3.0, minRms: 0.02, image: "images/5.jpg" },
  { type: "audio", mode: "guitar", prompt: "🎸 Final guitar lock: 2 seconds, clear sound.",     minSeconds: 2.0, minRms: 0.03, image: "images/6.jpg" },

  // Audio (Singing) forgiving (3 total)
  { type: "audio", mode: "sing",   prompt: "🎤 Hold any note for 2 seconds.",                    minSeconds: 2.0, minRms: 0.02, image: "images/7.jpg" },
  { type: "audio", mode: "sing",   prompt: "🎤 Opera moment: 3 seconds.",                        minSeconds: 3.0, minRms: 0.02, image: "images/8.jpg" },
  { type: "audio", mode: "sing",   prompt: "🎤 Sing/hum for 2 seconds (not a whisper).",         minSeconds: 2.0, minRms: 0.03, image: "images/9.jpg" },

  // Selfie / Camera (3 total)
  { type: "selfie", prompt: "🤳 Take a selfie with your biggest smile.",                          image: "images/10.jpg" },
  { type: "selfie", prompt: "🤳 Take a ‘serious movie poster’ selfie.",                           image: "images/11.jpg" },
  { type: "selfie", prompt: "🤳 Take a selfie holding the scrapbook page in frame.",              image: "images/12.jpg" },
];
